const CACHE_NAME = 'maria-onedrive-shell-v36';
const APP_SHELL = [
  './', './index.html', './manifest.json', './assets/css/styles.css?v=30', './assets/js/bootstrap.js?v=20',
