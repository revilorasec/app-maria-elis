const CACHE_NAME = 'maria-onedrive-shell-v37';
const APP_SHELL = [
  './', './index.html', './manifest.json', './assets/css/styles.css?v=30', './assets/js/bootstrap.js?v=21',
  ...
  './assets/js/next/app-next.js?v=20', './assets/js/next/appointments-next.js?v=21', './assets/js/next/supabase.js?v=20', './assets/js/next/config.js?v=20', './assets/js/next/permissions.js?v=20', './assets/js/next/file-picker.js?v=20', './assets/js/next/photo-editor.js?v=20', './assets/js/next/care-service.js?v=20', './assets/js/next/routine-service.js?v=20', './assets/js/next/ics.js?v=20', './assets/js/next/migration-preview.js?v=20', './assets/js/next/identity-client.js?v=20', './assets/js/next/document-service.js?v=20', './assets/js/next/recipe-service.js?v=20',
