const CACHE_NAME = 'maria-onedrive-shell-v17';
const APP_SHELL = [
  './', './index.html', './manifest.json', './assets/css/styles.css?v=16', './assets/js/app.js?v=17', './assets/js/appointmentEnhancements.js?v=17',
